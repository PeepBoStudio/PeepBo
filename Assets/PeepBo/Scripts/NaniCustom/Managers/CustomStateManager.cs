...
{
    [InitializeAtRuntime(@override: typeof(StateManager))]
    public class CustomStateManager : IStateManager
    {
        ...
        public CustomStateManager(StateConfiguration config, EngineConfiguration engineConfig)
        {
